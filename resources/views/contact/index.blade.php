        ...
        <div class="Form">
            <form method="POST" action="{{ route('contact.confirm') }}">
                ...
                <div class="Form-Item">
                    ...
                    <input class="Form-Item-Input" type="text" name="company" maxlength="20" value="{{ old('company') }}" placeholder="例）株式会社令和">
                ...
                <div class="Form-Item">
                    ...
                    <input class="Form-Item-Input" type="text" name="name" maxlength="20" value="{{ old('name') }}" placeholder="例）山田太郎">
                ...
                <div class="Form-Item">
                    ...
                    <input class="Form-Item-Input" type="tel" name="tel" value="{{ old('tel') }}" placeholder="例）000-0000-0000">
                ...
                <div class="Form-Item">
                    ...
                    <input class="Form-Item-Input" type="email" name="email" value="{{ old('email') }}" placeholder="例）example@gmail.com">
